import{q as l,g as r,u as d,l as c,a as v}from"./utils-CVAddTJ3.js";import{R as m}from"./RecipeData-D0GLeKtJ.js";class p{constructor(s,a){this.recipeId=s,this.dataSource=a,this.container=l("#recipe-details-container")}async init(){if(!this.recipeId){this.container.innerHTML='<p class="error-message">No recipe selected.</p>';return}const s=await this.dataSource.getRecipeDetails(this.recipeId);s?this.renderRecipe(s):this.container.innerHTML='<p class="error-message">Could not load recipe details.</p>'}renderRecipe(s){var o;const a=(r("favorites")||[]).some(e=>e.id===s.id),i=a?"saved":"",t=a?"❤️ Saved":"♡ Save to Favorites",n=`
